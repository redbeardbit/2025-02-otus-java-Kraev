...
hw01 - Проект gradle с модульной структурой\
hw02 - Применение коллекций\
hw03 - Свой тестовый фреймворк\
hw04 - Определение нужного размера хипа\
hw05 - Автоматическое логирование.\
hw06 - Эмулятор банкомата\
hw07 - Обработчик сообщений\
hw08 - Обработчик json-ов\
hw09 - Самодельный ORM\
hw10 - Использование Hibernate\
hw11 - Свой cache engine\
hw12 - Веб сервер\
hw13 - Домашнее задание (Собственный IoC контейнер)\
hw14 - Веб-приложение на Spring Boot\
hw15 - Последовательность чисел\
hw16 - Queues\
hw17 - gRPC клиент-серверное приложение или "Убить босса"\
hw18 - Комната 1408 
